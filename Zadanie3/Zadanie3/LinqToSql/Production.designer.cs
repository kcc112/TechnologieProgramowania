...
namespace Zadanie3.LinqToSql
{
    ...
    partial void InsertProductReview1(ProductReview1 instance);
    partial void UpdateProductReview1(ProductReview1 instance);
    partial void DeleteProductReview1(ProductReview1 instance);
    #endregion
		
		public ProductionDataContext() : 
				base(global::Zadanie3.Properties.Settings.Default.AdventureWorks2014_DataConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<ProductReview1> ProductReview1s
		{
			get
			{
				return this.GetTable<ProductReview1>();
			}
		}
	}
	...
	public partial class Product : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<ProductReview1> _ProductReview1s;
    ...
    partial void OnModifiedDateChanged();
		...
		public Product()
		{
			...
			this._ProductReview1s = new EntitySet<ProductReview1>(new Action<ProductReview1>(this.attach_ProductReview1s), new Action<ProductReview1>(this.detach_ProductReview1s));
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductReview1", Storage="_ProductReview1s", ThisKey="ProductID", OtherKey="ProductID")]
		public EntitySet<ProductReview1> ProductReview1s
		{
			get
			{
				return this._ProductReview1s;
			}
			set
			{
				this._ProductReview1s.Assign(value);
			}
		}
		...
		private void attach_ProductReview1s(ProductReview1 entity)
		{
			this.SendPropertyChanging();
			entity.Product = this;
		}
		
		private void detach_ProductReview1s(ProductReview1 entity)
		{
			this.SendPropertyChanging();
			entity.Product = null;
		}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="Production.ProductReview")]
	public partial class ProductReview1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Product_ProductReview1", Storage="_Product", ThisKey="ProductID", OtherKey="ProductID", IsForeignKey=true)]
		public Product Product
		{
			get
			{
			...
			set
			{
							...
							|| (this._Product.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._Product.Entity = null;
						previousValue.ProductReview1s.Remove(this);
					}
					this._Product.Entity = value;
					if ((value != null))
					{
						value.ProductReview1s.Add(this);
						this._ProductID = value.ProductID;
					}
					else
					{
