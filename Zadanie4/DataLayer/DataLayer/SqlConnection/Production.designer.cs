...
namespace DataLayer.SqlConnection
{
    ...
    partial void InsertVendor1(Vendor1 instance);
    partial void UpdateVendor1(Vendor1 instance);
    partial void DeleteVendor1(Vendor1 instance);
    #endregion
		...
		public System.Data.Linq.Table<Vendor1> Vendor1s
		{
			get
			{
				return this.GetTable<Vendor1>();
			}
		}
	}
	...
	public partial class ProductVendor : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Vendor1> _Vendor1;
    ...
    partial void OnModifiedDateChanged();
		...
		public ProductVendor()
		{
			...
			this._Vendor1 = default(EntityRef<Vendor1>);
			OnCreated();
		}
		...
		public int BusinessEntityID
		{
			...
			set
			{
				...
				{
					if ((this._Vendor.HasLoadedOrAssignedValue || this._Vendor1.HasLoadedOrAssignedValue))
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Vendor1_ProductVendor", Storage="_Vendor1", ThisKey="BusinessEntityID", OtherKey="BusinessEntityID", IsForeignKey=true)]
		public Vendor1 Vendor1
		{
			get
			{
			...
			set
			{
				Vendor1 previousValue = this._Vendor1.Entity;
				if (((previousValue != value) 
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="Purchasing.Vendor")]
	public partial class Vendor1 : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Vendor1_ProductVendor", Storage="_ProductVendors", ThisKey="BusinessEntityID", OtherKey="BusinessEntityID")]
		public EntitySet<ProductVendor> ProductVendors
		{
			get
			{
